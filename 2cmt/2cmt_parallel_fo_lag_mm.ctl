;; ==========================================================================
;; 2CMT_PARALLEL_FO_LAG_MM
;; #26 of the two-compartment set
...
$PROBLEM 2CMT parallel_fo_lag | Nonlinear elimination
...
$THETA  (0, 0.25)            ; 9 ALAG1  lag time, compartment 1 (h)
$THETA  (0, 1.0)             ; 10 ALAG2  lag time, compartment 2 (h)
...
$OMEGA  0 FIX            ; 10 IIV ALAG2 (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_parallel_fo_lag_mm.tab
$TABLE   ID VM KM V2 Q V3 KA1 KA2 DF ALAG1 ALAG2 ETA1 ETA2 ETA3 ETA4
         ETA5 ETA6 ETA7 ETA8 ETA9 ETA10
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_parallel_fo_lag_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_parallel_fo_lag_mm.tab
