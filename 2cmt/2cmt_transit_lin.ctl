...
$PROBLEM 2CMT transit | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_transit_lin.tab
$TABLE   ID CL V2 Q V3 KA MTT NN ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_transit_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_transit_lin.tab
