;; ==========================================================================
;; 2CMT_PARALLEL_FO_ZO_RATE_MMLIN
;; #39 of the two-compartment set
...
$PROBLEM 2CMT parallel_fo_zo_rate | Nonlinear and linear elimination
...
$THETA  (0, 50.0)            ; 8 R2     zero-order rate into cmt 2 (mg/h)
...
$OMEGA  0.09             ; 7 IIV KA
$OMEGA  0 FIX            ; 8 IIV R2    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_parallel_fo_zo_rate_mmlin.tab
$TABLE   ID CL V2 Q V3 VM KM KA R2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_parallel_fo_zo_rate_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_parallel_fo_zo_rate_mmlin.tab
