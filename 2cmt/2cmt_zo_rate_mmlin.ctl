...
$PROBLEM 2CMT zo_rate | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_zo_rate_mmlin.tab
$TABLE   ID CL V1 Q V2 VM KM R1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_zo_rate_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_zo_rate_mmlin.tab
