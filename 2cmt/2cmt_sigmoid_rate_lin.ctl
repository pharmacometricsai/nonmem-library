;; ==========================================================================
;; 2CMT_SIGMOID_RATE_LIN
;; #10 of the two-compartment set
...
$PROBLEM 2CMT sigmoid_rate | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_sigmoid_rate_lin.tab
$TABLE   ID CL V2 Q V3 KA R1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_sigmoid_rate_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_sigmoid_rate_lin.tab
