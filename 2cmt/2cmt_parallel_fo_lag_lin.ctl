;; ==========================================================================
;; 2CMT_PARALLEL_FO_LAG_LIN
;; #25 of the two-compartment set
...
$PROBLEM 2CMT parallel_fo_lag | Linear elimination
...
$OMEGA  0 FIX            ; 9 IIV ALAG2 (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_parallel_fo_lag_lin.tab
$TABLE   ID CL V2 Q V3 KA1 KA2 DF ALAG1 ALAG2 ETA1 ETA2 ETA3 ETA4 ETA5
         ETA6 ETA7 ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_parallel_fo_lag_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_parallel_fo_lag_lin.tab
