;; ==========================================================================
;; 2CMT_SEQ_FO_ZO_RATE_MMLIN
;; #33 of the two-compartment set
...
$PROBLEM 2CMT seq_fo_zo_rate | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_mmlin.tab
$TABLE   ID CL V2 Q V3 VM KM KA R2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_mmlin.tab
