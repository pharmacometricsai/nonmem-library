...
$PROBLEM 2CMT zo_dur | Nonlinear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_zo_dur_mm.tab
$TABLE   ID VM KM V1 Q V2 D1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_zo_dur_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_zo_dur_mm.tab
