...
$PROBLEM 2CMT fo_lag | Linear elimination
...
$OMEGA  0.09             ; 4 IIV V3
$OMEGA  0.09             ; 5 IIV KA
$OMEGA  0 FIX            ; 6 IIV ALAG1 (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_fo_lag_lin.tab
$TABLE   ID CL V2 Q V3 KA ALAG1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_fo_lag_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_fo_lag_lin.tab
