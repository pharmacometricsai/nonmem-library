...
$PROBLEM 2CMT seq_fo_zo_rate | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES PRED
         ...
         ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_lin.tab
$TABLE   ID CL V2 Q V3 KA R2 DF ET1 ET2 ET3 ET4 ET5 ET6 ET7
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_lin_sim.tab
