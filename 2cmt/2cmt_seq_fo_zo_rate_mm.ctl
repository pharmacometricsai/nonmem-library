...
$PROBLEM 2CMT seq_fo_zo_rate | Nonlinear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES PRED
         ...
         ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_mm.tab
$TABLE   ID VM KM V2 Q V3 KA R2 DF ET1 ET2 ET3 ET4 ET5 ET6 ET7 ET8
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_seq_fo_zo_rate_mm_sim.tab
