;; ==========================================================================
;; 2CMT_SIGMOID_DUR_MMLIN
;; #9 of the two-compartment set
...
$PROBLEM 2CMT sigmoid_dur | Nonlinear and linear elimination
...
$THETA  (0, 2.0)             ; 8 D1     zero-order duration into cmt 1 (h)
...
$OMEGA  0.09             ; 7 IIV KA
$OMEGA  0 FIX            ; 8 IIV D1    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_sigmoid_dur_mmlin.tab
$TABLE   ID CL V2 Q V3 VM KM KA D1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         ETA8
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_sigmoid_dur_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_sigmoid_dur_mmlin.tab
