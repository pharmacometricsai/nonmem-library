;; ==========================================================================
;; 2CMT_SIGMOID_RATE_MM
;; #11 of the two-compartment set
...
$PROBLEM 2CMT sigmoid_rate | Nonlinear elimination
...
$THETA  (0, 50.0)            ; 7 R1     zero-order rate into cmt 1 (mg/h)
...
$OMEGA  0.09             ; 5 IIV V3
$OMEGA  0.09             ; 6 IIV KA
$OMEGA  0 FIX            ; 7 IIV R1    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_sigmoid_rate_mm.tab
$TABLE   ID VM KM V2 Q V3 KA R1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_sigmoid_rate_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_sigmoid_rate_mm.tab
