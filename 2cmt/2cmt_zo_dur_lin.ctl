...
$PROBLEM 2CMT zo_dur | Linear elimination
...
$OMEGA  0.09             ; 3 IIV Q
$OMEGA  0.09             ; 4 IIV V2
$OMEGA  0 FIX            ; 5 IIV D1    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_zo_dur_lin.tab
$TABLE   ID CL V1 Q V2 D1 ETA1 ETA2 ETA3 ETA4 ETA5
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_zo_dur_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_zo_dur_lin.tab
