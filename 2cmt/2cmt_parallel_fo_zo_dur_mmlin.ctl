;; ==========================================================================
;; 2CMT_PARALLEL_FO_ZO_DUR_MMLIN
;; #36 of the two-compartment set
...
$PROBLEM 2CMT parallel_fo_zo_dur | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_parallel_fo_zo_dur_mmlin.tab
$TABLE   ID CL V2 Q V3 VM KM KA D2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_parallel_fo_zo_dur_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_parallel_fo_zo_dur_mmlin.tab
