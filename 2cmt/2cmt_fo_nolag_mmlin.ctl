...
$PROBLEM 2CMT fo_nolag | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=2cmt_fo_nolag_mmlin.tab
$TABLE   ID CL V2 Q V3 VM KM KA ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=2cmt_fo_nolag_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=2cmt_fo_nolag_mmlin.tab
