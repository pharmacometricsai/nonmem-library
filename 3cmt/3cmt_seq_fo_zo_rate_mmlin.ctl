...
$PROBLEM 3CMT seq_fo_zo_rate | Nonlinear and linear elimination
...
$THETA  (0, 50.0)            ; 10 R2     zero-order rate into cmt 2 (mg/h)
...
$OMEGA  0.09             ; 9 IIV KA
$OMEGA  0 FIX            ; 10 IIV R2    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES PRED
         RES WRES ET1 ET2 ET3 ET4 ET5 ET6 ET7 ET8 ET9 ET10 ET11 SG1 SG2
         ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_rate_mmlin.tab
$TABLE   ID CL V2 Q3 V3 Q4 V4 VM KM KA R2 DF ET1 ET2 ET3 ET4 ET5 ET6 ET7
         ET8 ET9 ET10 ET11
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_rate_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_rate_mmlin_sim.tab
