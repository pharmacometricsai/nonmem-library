;; ==========================================================================
;; 3CMT_TRANSIT_MMLIN
;; #21 of the three-compartment set
...
$PROBLEM 3CMT transit | Nonlinear and linear elimination
...
$THETA  (0, 2.0)             ; 10 MTT    mean transit time (h)
$THETA  (0.1, 5.0)           ; 11 NN     number of transit compartments
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_transit_mmlin.tab
$TABLE   ID CL V2 Q3 V3 Q4 V4 VM KM KA MTT NN ETA1 ETA2 ETA3 ETA4 ETA5
         ETA6 ETA7 ETA8 ETA9 ETA10
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_transit_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_transit_mmlin.tab
