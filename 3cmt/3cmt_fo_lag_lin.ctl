;; ==========================================================================
;; 3CMT_FO_LAG_LIN
;; #4 of the three-compartment set
...
$PROBLEM 3CMT fo_lag | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_fo_lag_lin.tab
$TABLE   ID CL V2 Q3 V3 Q4 V4 KA ALAG1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         ETA7 ETA8
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_fo_lag_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_fo_lag_lin.tab
