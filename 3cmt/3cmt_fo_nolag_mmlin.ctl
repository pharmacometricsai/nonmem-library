;; ==========================================================================
;; 3CMT_FO_NOLAG_MMLIN
;; #3 of the three-compartment set
...
$PROBLEM 3CMT fo_nolag | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_fo_nolag_mmlin.tab
$TABLE   ID CL V2 Q3 V3 Q4 V4 VM KM KA ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         ETA7 ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_fo_nolag_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_fo_nolag_mmlin.tab
