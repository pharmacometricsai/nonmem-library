;; ==========================================================================
;; 3CMT_ZO_DUR_MM
;; #14 of the three-compartment set
...
$PROBLEM 3CMT zo_dur | Nonlinear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_zo_dur_mm.tab
$TABLE   ID VM KM V1 Q2 V2 Q3 V3 D1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         ETA8
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_zo_dur_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_zo_dur_mm.tab
