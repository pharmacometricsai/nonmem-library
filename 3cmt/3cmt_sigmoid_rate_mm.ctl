;; ==========================================================================
;; 3CMT_SIGMOID_RATE_MM
;; #11 of the three-compartment set
...
$PROBLEM 3CMT sigmoid_rate | Nonlinear elimination
...
$THETA  (0, 50.0)            ; 9 R1     zero-order rate into cmt 1 (mg/h)
...
$OMEGA  0.09             ; 7 IIV V4
$OMEGA  0.09             ; 8 IIV KA
$OMEGA  0 FIX            ; 9 IIV R1    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_sigmoid_rate_mm.tab
$TABLE   ID VM KM V2 Q3 V3 Q4 V4 KA R1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         ETA7 ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_sigmoid_rate_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_sigmoid_rate_mm.tab
