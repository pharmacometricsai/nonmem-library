...
;; #39 of the three-compartment set
...
$TABLE   ID CL V2 Q3 V3 Q4 V4 VM KM KA R2 DF ETA1 ETA2 ETA3 ETA4 ETA5
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_parallel_fo_zo_rate_mmlin.tab
