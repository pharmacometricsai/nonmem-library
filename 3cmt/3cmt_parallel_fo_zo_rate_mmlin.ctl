;; ==========================================================================
;; 3CMT_PARALLEL_FO_ZO_RATE_MMLIN
...
$PROBLEM 3CMT parallel_fo_zo_rate | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES PRED
         ...
         ONEHEADER NOPRINT FILE=3cmt_parallel_fo_zo_rate_mmlin.tab
$TABLE   ID CL V2 Q3 V3 Q4 V4 VM KM KA R2 DF ET1 ET2 ET3 ET4 ET5 ET6 ET7
         ET8 ET9 ET10 ET11
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_parallel_fo_zo_rate_mmlin.par
...
;          FILE=3cmt_parallel_fo_zo_rate_mmlin_sim.tab
