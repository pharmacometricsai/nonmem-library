;; ==========================================================================
;; 3CMT_ZO_RATE_LIN
;; #16 of the three-compartment set
...
$PROBLEM 3CMT zo_rate | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_zo_rate_lin.tab
$TABLE   ID CL V1 Q2 V2 Q3 V3 R1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_zo_rate_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_zo_rate_lin.tab
