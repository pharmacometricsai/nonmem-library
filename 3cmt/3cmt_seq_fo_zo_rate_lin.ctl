;; ==========================================================================
;; 3CMT_SEQ_FO_ZO_RATE_LIN
;; #31 of the three-compartment set
...
$PROBLEM 3CMT seq_fo_zo_rate | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_rate_lin.tab
$TABLE   ID CL V2 Q3 V3 Q4 V4 KA R2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         ETA7 ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_rate_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_rate_lin.tab
