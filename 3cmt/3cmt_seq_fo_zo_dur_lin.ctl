...
$PROBLEM 3CMT seq_fo_zo_dur | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES PRED
         ...
         ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_dur_lin.tab
$TABLE   ID CL V2 Q3 V3 Q4 V4 KA D2 DF ET1 ET2 ET3 ET4 ET5 ET6 ET7 ET8
         ET9
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_dur_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_seq_fo_zo_dur_lin_sim.tab
