;; ==========================================================================
;; 3CMT_ZO_DUR_MMLIN
;; #15 of the three-compartment set
...
$PROBLEM 3CMT zo_dur | Nonlinear and linear elimination
...
$THETA  (0, 2.0)             ; 9 D1     zero-order duration into cmt 1 (h)
...
$OMEGA  0 FIX            ; 9 IIV D1    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=3cmt_zo_dur_mmlin.tab
$TABLE   ID CL V1 Q2 V2 Q3 V3 VM KM D1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         ETA7 ETA8 ETA9
         FIRSTONLY ONEHEADER NOPRINT FILE=3cmt_zo_dur_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=3cmt_zo_dur_mmlin.tab
