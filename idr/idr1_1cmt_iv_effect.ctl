...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=idr1_1cmt_iv_effect.tab
$TABLE   ID TIME CP CE EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr1_1cmt_iv_effect.prof
$TABLE   ID CL V KE0 R0 KOUT IMAX IC50 HILL KIN ET1 ET2 ET3 ET4 ET5 ET6
         ET7 ET8
         FIRSTONLY ONEHEADER NOPRINT FILE=idr1_1cmt_iv_effect.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr1_1cmt_iv_effect_sim.tab
