...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=idr2_2cmt_oral_effect.tab
$TABLE   ID TIME CP CE EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr2_2cmt_oral_effect.prof
$TABLE   ID CL V2 Q V3 KA F1 KE0 R0 KOUT IMAX IC50 HILL KIN ETA1 ETA2
         ETA3 ETA4 ETA5 ETA6 ETA7 ETA8 ETA9 ETA10 ETA11 ETA12
         FIRSTONLY ONEHEADER NOPRINT FILE=idr2_2cmt_oral_effect.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr2_2cmt_oral_effect.tab
