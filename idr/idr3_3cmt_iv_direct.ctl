...
; ---- typical values and between-subject variability ------------------
  ...
  SMAX  = THETA(9)*EXP(ETA(9))
  SC50  = THETA(10)*EXP(ETA(10))
...
$DES
  ...
  IF(CD.GT.0) THEN
    ...
    EFF = XX/(1+XX)
  ENDIF
  DADT(4) = KIN*(1 + SMAX*EFF) - KOUT*A(4)
...
$THETA  (0, 2.0)             ; 9 SMAX  max. fractional stimulation
$THETA  (0, 1.0)             ; 10 SC50  conc. for 50% of SMAX (mg/L)
...
$OMEGA  0 FIX            ; 9 IIV SMAX  (free it if the data support it)
$OMEGA  0.09             ; 10 IIV SC50
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         SG2 SG3 SG4
         ONEHEADER NOPRINT FILE=idr3_3cmt_iv_direct.tab
$TABLE   ID TIME CP EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr3_3cmt_iv_direct.prof
$TABLE   ID CL V2 Q3 V3 Q4 V4 R0 KOUT SMAX SC50 HILL KIN ET1 ET2 ET3 ET4
         ET5 ET6 ET7 ET8 ET9 ET10 ET11
         FIRSTONLY ONEHEADER NOPRINT FILE=idr3_3cmt_iv_direct.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr3_3cmt_iv_direct_sim.tab
