...
$DES
  ...
  IF(CD.GT.0) THEN
    ...
    EFF = XX/(1+XX)
  ENDIF
  DADT(5) = KIN*(1 - IMAX*EFF) - KOUT*A(5)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=idr1_3cmt_oral_direct.tab
$TABLE   ID TIME CP EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr1_3cmt_oral_direct.prof
$TABLE   ID CL V2 Q3 V3 Q4 V4 KA F1 R0 KOUT IMAX IC50 HILL KIN ET1 ET2
         ET3 ET4 ET5 ET6 ET7 ET8 ET9 ET10 ET11 ET12 ET13
         FIRSTONLY ONEHEADER NOPRINT FILE=idr1_3cmt_oral_direct.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr1_3cmt_oral_direct_sim.tab
