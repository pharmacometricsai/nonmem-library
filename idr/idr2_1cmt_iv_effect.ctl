...
; ---- typical values and between-subject variability ------------------
  ...
  LGTIMA = LOG(THETA(6)/(1-THETA(6))) + ETA(6)
...
$THETA  (0.001, 0.8, 0.999)  ; 6 IMAX  max. inhibition (logit-scale IIV)
$THETA  (0, 1.0)             ; 7 IC50  conc. for 50% of IMAX (mg/L)
...
$OMEGA  0 FIX            ; 6 IIV IMAX  (free it if the data support it)
$OMEGA  0.09             ; 7 IIV IC50
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=idr2_1cmt_iv_effect.tab
$TABLE   ID TIME CP CE EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr2_1cmt_iv_effect.prof
$TABLE   ID CL V KE0 R0 KOUT IMAX IC50 HILL KIN ET1 ET2 ET3 ET4 ET5 ET6
         ET7 ET8
         FIRSTONLY ONEHEADER NOPRINT FILE=idr2_1cmt_iv_effect.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr2_1cmt_iv_effect_sim.tab
