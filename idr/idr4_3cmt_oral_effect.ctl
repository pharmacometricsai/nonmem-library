...
$DES
  ...
  IF(CD.GT.0) THEN
    ...
    EFF = XX/(1+XX)
  ENDIF
  DADT(6) = KIN - KOUT*(1 + SMAX*EFF)*A(6)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=idr4_3cmt_oral_effect.tab
$TABLE   ID TIME CP CE EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr4_3cmt_oral_effect.prof
$TABLE   ID CL V2 Q3 V3 Q4 V4 KA F1 KE0 R0 KOUT SMAX SC50 HILL KIN ETA1
         ...
         ETA14
         FIRSTONLY ONEHEADER NOPRINT FILE=idr4_3cmt_oral_effect.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr4_3cmt_oral_effect.tab
