...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         SG3 SG4
         ONEHEADER NOPRINT FILE=idr2_1cmt_oral_effect.tab
$TABLE   ID TIME CP CE EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr2_1cmt_oral_effect.prof
$TABLE   ID CL V KA F1 KE0 R0 KOUT IMAX IC50 HILL KIN ET1 ET2 ET3 ET4
         ET5 ET6 ET7 ET8 ET9 ET10
         FIRSTONLY ONEHEADER NOPRINT FILE=idr2_1cmt_oral_effect.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr2_1cmt_oral_effect_sim.tab
