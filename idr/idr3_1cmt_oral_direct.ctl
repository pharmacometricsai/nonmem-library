...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         SG4
         ONEHEADER NOPRINT FILE=idr3_1cmt_oral_direct.tab
$TABLE   ID TIME CP EFF FACT RESP
         ONEHEADER NOPRINT FILE=idr3_1cmt_oral_direct.prof
$TABLE   ID CL V KA F1 R0 KOUT SMAX SC50 HILL KIN ET1 ET2 ET3 ET4 ET5
         ET6 ET7 ET8 ET9
         FIRSTONLY ONEHEADER NOPRINT FILE=idr3_1cmt_oral_direct.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=idr3_1cmt_oral_direct_sim.tab
