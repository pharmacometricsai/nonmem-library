;; ==========================================================================
;; 1CMT_PARALLEL_FO_NOLAG_MMLIN
;; #24 of the one-compartment set
...
$PROBLEM 1CMT parallel_fo_nolag | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_parallel_fo_nolag_mmlin.tab
$TABLE   ID CL V VM KM KA1 KA2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_parallel_fo_nolag_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_parallel_fo_nolag_mmlin.tab
