;; ==========================================================================
;; 1CMT_SEQ_FO_ZO_DUR_MMLIN
;; #30 of the one-compartment set
...
$PROBLEM 1CMT seq_fo_zo_dur | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_seq_fo_zo_dur_mmlin.tab
$TABLE   ID CL V VM KM KA D2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_seq_fo_zo_dur_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_seq_fo_zo_dur_mmlin.tab
