...
$PROBLEM 1CMT parallel_fo_zo_dur | Nonlinear and linear elimination
...
$OMEGA  0.09             ; 5 IIV KA
$OMEGA  0 FIX            ; 6 IIV D2    (free to estimate if supported)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_dur_mmlin.tab
$TABLE   ID CL V VM KM KA D2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_dur_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_dur_mmlin.tab
