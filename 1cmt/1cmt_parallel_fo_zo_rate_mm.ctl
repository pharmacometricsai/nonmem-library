;; ==========================================================================
;; 1CMT_PARALLEL_FO_ZO_RATE_MM
;; #38 of the one-compartment set
...
$PROBLEM 1CMT parallel_fo_zo_rate | Nonlinear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_rate_mm.tab
$TABLE   ID VM KM V KA R2 DF ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_rate_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_rate_mm.tab
