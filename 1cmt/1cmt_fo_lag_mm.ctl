;; ==========================================================================
;; 1CMT_FO_LAG_MM
;; #5 of the one-compartment set
;;   First-order absorption with lag time
;;   Nonlinear elimination
;; --------------------------------------------------------------------------
;; Structure
;;   Dose at t=ALAG1 --> [Depot] --Ka--> [Central (V)] --Vmax/Km-->
;;
...
$PROBLEM 1CMT fo_lag | Nonlinear elimination
...
$THETA  (0, 0.25)            ; 5 ALAG1  lag time, compartment 1 (h)

$OMEGA  0.09             ; 1 IIV VM
$OMEGA  0 FIX            ; 2 IIV KM    (free to estimate if supported)
$OMEGA  0.09             ; 3 IIV V
$OMEGA  0.09             ; 4 IIV KA
$OMEGA  0 FIX            ; 5 IIV ALAG1 (free to estimate if supported)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_fo_lag_mm.tab
$TABLE   ID VM KM V KA ALAG1 ETA1 ETA2 ETA3 ETA4 ETA5
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_fo_lag_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_fo_lag_mm.tab
