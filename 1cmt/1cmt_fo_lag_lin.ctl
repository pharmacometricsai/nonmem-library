;; ==========================================================================
;; 1CMT_FO_LAG_LIN
;; #4 of the one-compartment set
;;   First-order absorption with lag time
;;   Linear elimination
;; --------------------------------------------------------------------------
;; Structure
;;   Dose at t=ALAG1 --> [Depot] --Ka--> [Central (V)] --CL-->
;;
...
$PROBLEM 1CMT fo_lag | Linear elimination
...
$THETA  (0, 0.25)            ; 4 ALAG1  lag time, compartment 1 (h)

$OMEGA  0.09             ; 1 IIV CL
$OMEGA  0.09             ; 2 IIV V
$OMEGA  0.09             ; 3 IIV KA
$OMEGA  0 FIX            ; 4 IIV ALAG1 (free to estimate if supported)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_fo_lag_lin.tab
$TABLE   ID CL V KA ALAG1 ETA1 ETA2 ETA3 ETA4
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_fo_lag_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_fo_lag_lin.tab
