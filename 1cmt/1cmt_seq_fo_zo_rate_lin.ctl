;; ==========================================================================
;; 1CMT_SEQ_FO_ZO_RATE_LIN
;; #31 of the one-compartment set
...
$PROBLEM 1CMT seq_fo_zo_rate | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_seq_fo_zo_rate_lin.tab
$TABLE   ID CL V KA R2 DF ETA1 ETA2 ETA3 ETA4 ETA5
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_seq_fo_zo_rate_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_seq_fo_zo_rate_lin.tab
