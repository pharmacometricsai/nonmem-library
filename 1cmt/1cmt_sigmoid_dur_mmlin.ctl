;; ==========================================================================
;; 1CMT_SIGMOID_DUR_MMLIN
;; #9 of the one-compartment set
;;   Sigmoid absorption with duration
;;   Nonlinear and linear elimination
;; --------------------------------------------------------------------------
;; Structure
;;   Dose --(zero-order, D1)--> [Depot] --Ka--> [Central (V)] --CL +
;;     Vmax/Km-->
;;
...
$PROBLEM 1CMT sigmoid_dur | Nonlinear and linear elimination
...
$OMEGA  0.09             ; 5 IIV KA
$OMEGA  0 FIX            ; 6 IIV D1    (free to estimate if supported)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_sigmoid_dur_mmlin.tab
$TABLE   ID CL V VM KM KA D1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_sigmoid_dur_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_sigmoid_dur_mmlin.tab
