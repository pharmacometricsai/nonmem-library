;; ==========================================================================
;; 1CMT_ZO_RATE_MMLIN
;; #18 of the one-compartment set
;;   Zero-order absorption with rate
;;   Nonlinear and linear elimination
;; --------------------------------------------------------------------------
;; Structure
;;   Dose --(zero-order, R1)--> [Central (V)] --CL + Vmax/Km-->
;;
...
$PROBLEM 1CMT zo_rate | Nonlinear and linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_zo_rate_mmlin.tab
$TABLE   ID CL V VM KM R1 ETA1 ETA2 ETA3 ETA4 ETA5
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_zo_rate_mmlin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_zo_rate_mmlin.tab
