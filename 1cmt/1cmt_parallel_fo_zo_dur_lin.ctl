;; ==========================================================================
;; 1CMT_PARALLEL_FO_ZO_DUR_LIN
;; #34 of the one-compartment set
...
$PROBLEM 1CMT parallel_fo_zo_dur | Linear elimination
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_dur_lin.tab
$TABLE   ID CL V KA D2 DF ETA1 ETA2 ETA3 ETA4 ETA5
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_dur_lin.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_parallel_fo_zo_dur_lin.tab
