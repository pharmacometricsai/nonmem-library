;; ==========================================================================
;; 1CMT_SIGMOID_RATE_MM
;; #11 of the one-compartment set
;;   Sigmoid absorption with rate
;;   Nonlinear elimination
;; --------------------------------------------------------------------------
;; Structure
;;   Dose --(zero-order, R1)--> [Depot] --Ka--> [Central (V)] --Vmax/Km-->
;;
...
$PROBLEM 1CMT sigmoid_rate | Nonlinear elimination
...
$OMEGA  0.09             ; 3 IIV V
$OMEGA  0.09             ; 4 IIV KA
$OMEGA  0 FIX            ; 5 IIV R1    (free to estimate if supported)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_sigmoid_rate_mm.tab
$TABLE   ID VM KM V KA R1 ETA1 ETA2 ETA3 ETA4 ETA5
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_sigmoid_rate_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_sigmoid_rate_mm.tab
