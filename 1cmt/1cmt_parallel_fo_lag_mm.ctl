;; ==========================================================================
;; 1CMT_PARALLEL_FO_LAG_MM
;; #26 of the one-compartment set
...
$PROBLEM 1CMT parallel_fo_lag | Nonlinear elimination
...
$THETA  (0, 0.25)            ; 7 ALAG1  lag time, compartment 1 (h)
$THETA  (0, 1.0)             ; 8 ALAG2  lag time, compartment 2 (h)
...
$OMEGA  0 FIX            ; 7 IIV ALAG1 (free to estimate if supported)
$OMEGA  0 FIX            ; 8 IIV ALAG2 (free to estimate if supported)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT DV IPRED IRES IWRES CWRES
         PRED RES WRES
         ONEHEADER NOPRINT FILE=1cmt_parallel_fo_lag_mm.tab
$TABLE   ID VM KM V KA1 KA2 DF ALAG1 ALAG2 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6
         ETA7 ETA8
         FIRSTONLY ONEHEADER NOPRINT FILE=1cmt_parallel_fo_lag_mm.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=1cmt_parallel_fo_lag_mm.tab
