...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         SG4
         ONEHEADER NOPRINT FILE=tmdd_1cmt_full_sc.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_1cmt_full_sc.prof
$TABLE   ID CL V KON KOFF KINT KDEG R0 KA F1 ET1 ET2 ET3 ET4 ET5 ET6 ET7
         ET8 ET9
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_1cmt_full_sc.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_1cmt_full_sc_sim.tab
