...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sc.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sc.prof
$TABLE   ID CL V KD KINT R0 KA F1 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sc.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sc.tab
