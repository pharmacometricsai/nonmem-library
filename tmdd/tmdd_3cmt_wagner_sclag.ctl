...
$PROBLEM TMDD 3cmt wagner | sclag
...
$THETA  (0, 0.5)             ; 7 KD    equilibrium dissoc. constant (nM)
...
$OMEGA  0.09             ; 5 IIV Q4
$OMEGA  0.09             ; 6 IIV V4
$OMEGA  0 FIX            ; 7 IIV KD    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=tmdd_3cmt_wagner_sclag.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_3cmt_wagner_sclag.prof
$TABLE   ID CL V2 Q3 V3 Q4 V4 KD KINT R0 KA F1 ALAG1 ETA1 ETA2 ETA3 ETA4
         ETA5 ETA6 ETA7 ETA8 ETA9 ETA10 ETA11 ETA12
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_3cmt_wagner_sclag.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_3cmt_wagner_sclag.tab
