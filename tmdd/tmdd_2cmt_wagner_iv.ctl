...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=tmdd_2cmt_wagner_iv.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_2cmt_wagner_iv.prof
$TABLE   ID CL V2 Q V3 KD KINT R0 ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_2cmt_wagner_iv.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_2cmt_wagner_iv.tab
