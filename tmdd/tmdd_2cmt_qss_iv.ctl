...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=tmdd_2cmt_qss_iv.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_2cmt_qss_iv.prof
$TABLE   ID CL V2 Q V3 KSS KINT KDEG R0 ET1 ET2 ET3 ET4 ET5 ET6 ET7 ET8
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_2cmt_qss_iv.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_2cmt_qss_iv_sim.tab
