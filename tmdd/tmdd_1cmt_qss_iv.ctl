...
$DES
  ...
  DADT(2) =  KDEG*R0*V - KDEG*RF*V - KINT*RC*V
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         PRED RES WRES ET1 ET2 ET3 ET4 ET5 ET6 SG1 SG2 SG3 SG4
         ONEHEADER NOPRINT FILE=tmdd_1cmt_qss_iv.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_1cmt_qss_iv.prof
$TABLE   ID CL V KSS KINT KDEG R0 ET1 ET2 ET3 ET4 ET5 ET6
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_1cmt_qss_iv.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_1cmt_qss_iv_sim.tab
