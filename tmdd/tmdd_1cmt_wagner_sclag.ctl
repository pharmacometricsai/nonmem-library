...
$PROBLEM TMDD 1cmt wagner | sclag
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sclag.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sclag.prof
$TABLE   ID CL V KD KINT R0 KA F1 ALAG1 ET1 ET2 ET3 ET4 ET5 ET6 ET7 ET8
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sclag.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_1cmt_wagner_sclag_sim.tab
