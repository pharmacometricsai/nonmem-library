...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         SG2 SG3 SG4
         ONEHEADER NOPRINT FILE=tmdd_2cmt_qe_sclag.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_2cmt_qe_sclag.prof
$TABLE   ID CL V2 Q V3 KD KINT KDEG R0 KA F1 ALAG1 ET1 ET2 ET3 ET4 ET5
         ET6 ET7 ET8 ET9 ET10 ET11
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_2cmt_qe_sclag.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_2cmt_qe_sclag_sim.tab
