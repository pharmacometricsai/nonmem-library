...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=tmdd_1cmt_mm_iv.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_1cmt_mm_iv.prof
$TABLE   ID CL V VM KM R0 ETA1 ETA2 ETA3 ETA4 ETA5
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_1cmt_mm_iv.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_1cmt_mm_iv.tab
