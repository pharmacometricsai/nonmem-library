...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         SG4
         ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_sclag.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_sclag.prof
$TABLE   ID CL V KD KINT KDEG R0 KA F1 ALAG1 ET1 ET2 ET3 ET4 ET5 ET6 ET7
         ET8 ET9
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_sclag.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_sclag_sim.tab
