...
$THETA  (0, 0.1)             ; 13 ALAG1 absorption lag time (day)
...
$OMEGA  0 FIX            ; 13 IIV ALAG1 (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sclag.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sclag.prof
$TABLE   ID CL V2 Q3 V3 Q4 V4 KD KINT KDEG R0 KA F1 ALAG1 ET1 ET2 ET3
         ET4 ET5 ET6 ET7 ET8 ET9 ET10 ET11 ET12 ET13
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sclag.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sclag_sim.tab
