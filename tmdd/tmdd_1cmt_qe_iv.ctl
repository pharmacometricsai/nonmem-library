...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_iv.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_iv.prof
$TABLE   ID CL V KD KINT KDEG R0 ET1 ET2 ET3 ET4 ET5 ET6
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_iv.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_1cmt_qe_iv_sim.tab
