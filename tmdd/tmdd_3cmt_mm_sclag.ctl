...
$DES
  ...
  DIST2= Q4*(C - CP2)
  DADT(1) = -KA*A(1)
  DADT(2) = KA*A(1) - CL*C - DIST1 - DIST2 - VM*C/(KM+C)
  DADT(3) =  DIST1
  DADT(4) =  DIST2
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=tmdd_3cmt_mm_sclag.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_3cmt_mm_sclag.prof
$TABLE   ID CL V2 Q3 V3 Q4 V4 VM KM R0 KA F1 ALAG1 ETA1 ETA2 ETA3 ETA4
         ETA5 ETA6 ETA7 ETA8 ETA9 ETA10 ETA11 ETA12
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_3cmt_mm_sclag.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_3cmt_mm_sclag.tab
