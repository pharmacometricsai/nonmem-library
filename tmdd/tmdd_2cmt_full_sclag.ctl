...
; compartment 4 = free target
; compartment 5 = drug-target complex
...
; ---- typical values and between-subject variability ------------------
  ...
  LGTF1 = LOG(THETA(11)/(1-THETA(11))) + ETA(11)
...
$DES
  ...
  DIST1= Q*(C - CP1)
  DADT(1) = -KA*A(1)
  DADT(2) = KA*A(1) - CL*C - DIST1 - BIND
  DADT(3) =  DIST1
  DADT(4) =  KDEG*R0*V2 - KDEG*RF*V2 - BIND
  DADT(5) =  BIND - KINT*RC*V2
...
$THETA  (0, 0.25)            ; 10 KA    absorption rate constant (1/day)
$THETA  (0.001, 0.7, 0.999)  ; 11 F1    SC bioavailability (logit-scale IIV)
$THETA  (0, 0.1)             ; 12 ALAG1 absorption lag time (day)
...
$OMEGA  0.09             ; 9 IIV R0
$OMEGA  0.09             ; 10 IIV KA
$OMEGA  0 FIX            ; 11 IIV F1    (free it if the data support it)
...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES CWRES
         ...
         ONEHEADER NOPRINT FILE=tmdd_2cmt_full_sclag.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_2cmt_full_sclag.prof
$TABLE   ID CL V2 Q V3 KON KOFF KINT KDEG R0 KA F1 ALAG1 ET1 ET2 ET3 ET4
         ET5 ET6 ET7 ET8 ET9 ET10 ET11 ET12
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_2cmt_full_sclag.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_2cmt_full_sclag_sim.tab
