...
$TABLE   ID TIME AMT RATE EVID MDV CMT FLAG DV IPRED IRES IWRES
         CWRES PRED RES WRES
         ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sc.tab
$TABLE   ID TIME CFR CTOT RFR RCX RTOT
         ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sc.prof
$TABLE   ID CL V2 Q3 V3 Q4 V4 KD KINT KDEG R0 KA F1 ETA1 ETA2 ETA3 ETA4
         ETA5 ETA6 ETA7 ETA8 ETA9 ETA10 ETA11 ETA12
         FIRSTONLY ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sc.par
...
;        NOAPPEND ONEHEADER NOPRINT FILE=tmdd_3cmt_qe_sc.tab
